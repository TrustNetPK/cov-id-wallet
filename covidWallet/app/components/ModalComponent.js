        ...
        <View style={styles.ModalChildContainer}>
            ...
            {props.data !== undefined && (
              <View style={styles.modalValuesContainer}>
                ...
                <Text style={styles.modalValues}>
                  {String(props.data.firstname)}
                </Text>
                <Text style={styles.modalTitles}>Last Name</Text>
                <Text style={styles.modalValues}>
                  {String(props.data.lastname)}
                </Text>
                ...
                <Text style={styles.modalValues}>
                  {props.data.nextBoosterDate}
                </Text>
                <Text style={styles.modalTitles}>Vaccinator Name</Text>
                <Text style={styles.modalValues}>
                  {props.data.vaccinatorName}
                </Text>
                <Text style={styles.modalTitles}>
                  Accreditor Credential Defination ID
                </Text>
                <Text style={styles.modalValues}>
                  {props.data.accreditor_cred_def_id}
                </Text>
                <Text style={styles.modalTitles}>Vaccination Organization</Text>
                <Text style={styles.modalValues}>
                  {props.data.vaccinator_org}
                </Text>
                <Text style={styles.modalTitles}>
                  Vaccination Organization Type
                </Text>
                <Text style={styles.modalValues}>
                  {props.data.vaccinator_org_type}
                </Text>
                <Text style={styles.modalTitles}>
                  Vaccination Oragnization Location
                </Text>
                <Text style={styles.modalValues}>
                  {props.data.vaccinator_org_loc}
                </Text>
                <Text style={styles.modalTitles}>Validation Duration</Text>
                <Text style={styles.modalValues}>
                  {props.data.validate_from} to {props.data.validTill}
                </Text>
              </View>
            )}
          </ScrollView>
          ...
          <View style={styles.centerContainer}>
            {props.modalType === 'action' && (
              <PrimaryButton text="Accept" nextHandler={props.acceptModal} />
            )}
            {props.modalType === 'action' && (
              <PrimaryButton
                isVisible={props.modalType === 'action'}
                text="Reject"
