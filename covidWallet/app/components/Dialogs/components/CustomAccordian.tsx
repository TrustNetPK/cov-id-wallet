...
const CustomAccordian = (props: INProps) => {
        ...
        {Object.keys(cred.values).map((v, i) => (
          <View
            style={{
              ...
              borderBottomWidth:
                i == Object.keys(cred.values).length - 1 ? 0 : 0.5,
  ...
  return credentials.length ? (
      ...
      <View style={styles._mainContainer}>
        <View style={styles._titleContainer}>
          ...
          <Text style={styles._titleStyle}>
            {cred != undefined && cred.values.Type != undefined
              ? cred.values.Type
    ...
    <Text
      ...
      Sorry! you don't have any credentials yet
    </Text>
  );
};
